...
const classes = computed(() => {
    return props.active
        ? "block w-full pl-4 lg:pl-12 pr-4 py-2 lg:rounded-xl text-center text-xl font-medium text-ptr-dark-pink fill-ptr-dark-pink bg-[#ffedf3] transition duration-150 ease-in-out"
