...
<style scoped>
.balloon-shadow {
    filter: drop-shadow(2px 5px 2px #fffafb);
}
.v-enter-active,
.v-leave-active {
    ...
    <div>
        <transition>
            ...
            >
                ...
                >
                    <svg
                        class="relative h-5 w-5 animate-bounce fill-ptr-main md:h-6 md:w-6"
                ...
                <svg
                    class="balloon-shadow pointer-events-none h-28 w-28 animate-float md:h-36 md:w-36"
                ...
                >
                    <path
                        ...
                        stroke-width="20"
                        class="pointer-events-auto cursor-pointer fill-none"
                    ...
                    <path
                        ...
                        stroke-width="15"
                        class="pointer-events-auto cursor-pointer stroke-white"
                        @click="emits('scrollTop')"
